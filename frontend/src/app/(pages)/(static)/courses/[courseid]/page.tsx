...
const CourseDetailPage = () => {
  ...
  return (
    <div className="bg-gray-50 min-h-screen pb-16">
              ...
              <div className="bg-white rounded-xl shadow-sm p-6 mt-8">
                ...
                <ul className="space-y-3">
                  <li>
                    <Link
                      href="#"
                      className="flex items-center text-indigo-700 hover:text-indigo-600 transition-colors"
                    >
      ...
      {/* Call-to-Action */}
      <section className="py-16 bg-gradient-to-r from-indigo-800 to-indigo-900 text-white mt-8">
        <div className="container mx-auto px-4">
